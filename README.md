...
| **MrAurevoX Kit** | [`MrAurevoX-Kit-v0.1.0`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/MrAurevoX-Kit-v0.1.0) | `org.mraurevox.MrAurevoXKit.flatpak` |

## Crypto Tracker 1.2.7

```bash
curl -fL -o org.mraurevox.CryptoTracker.flatpak \
  https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/crypto-tracker-v1.2.7/org.mraurevox.CryptoTracker.flatpak
...
- Texte complet : [`LEGAL-Crypto-Tracker.md`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/blob/main/LEGAL-Crypto-Tracker.md) et [`LEGAL.md`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/crypto-tracker-v1.2.7/LEGAL.md) (joint à la release). App : Paramètres → CGU / RGPD.
...
curl -fL -o org.mraurevox.MrAurevoXKit.flatpak \
  https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/MrAurevoX-Kit-v0.1.0/org.mraurevox.MrAurevoXKit.flatpak
