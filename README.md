...
| --- | --- | --- |
| **Crypto Tracker** | [`crypto-tracker-v1.2.2`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/crypto-tracker-v1.2.2) | `org.mraurevox.CryptoTracker.flatpak` |
...
curl -fL -o org.mraurevox.CryptoTracker.flatpak \
  https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/crypto-tracker-v1.2.2/org.mraurevox.CryptoTracker.flatpak
...
curl -fL -o org.mraurevox.GestLinuxPro.flatpak \
  https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/Gest_Linux_Pro-v1.4.3/org.mraurevox.GestLinuxPro.flatpak
