...
| --- | --- | --- |
| **Crypto Tracker** | [`crypto-tracker-v1.2.14`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/crypto-tracker-v1.2.14) | `org.mraurevox.CryptoTracker.flatpak` |
| **Gest Linux Pro** | [`Gest_Linux_Pro-v1.4.11`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/Gest_Linux_Pro-v1.4.11) | `org.mraurevox.GestLinuxPro.flatpak` |
| **MrAurevoX Kit** | [`MrAurevoX-Kit-v1.0.0`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/MrAurevoX-Kit-v1.0.0) | `org.mraurevox.MrAurevoXKit.flatpak` |

## Crypto Tracker 1.2.14

```bash
curl -fL -o org.mraurevox.CryptoTracker.flatpak \
  https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/crypto-tracker-v1.2.14/org.mraurevox.CryptoTracker.flatpak
...
- Texte complet : [`LEGAL-Crypto-Tracker.md`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/blob/main/LEGAL-Crypto-Tracker.md) et [`LEGAL.md`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/crypto-tracker-v1.2.14/LEGAL.md) (joint à la release). App : Paramètres → CGU / RGPD.
...
curl -fL -o org.mraurevox.MrAurevoXKit.flatpak \
  https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/MrAurevoX-Kit-v1.0.0/org.mraurevox.MrAurevoXKit.flatpak
