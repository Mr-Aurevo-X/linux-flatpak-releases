...
| --- | --- | --- |
| **Crypto Tracker** | [`crypto-tracker-v1.2.21`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/crypto-tracker-v1.2.21) | `org.mraurevox.CryptoTracker.flatpak` |

## Crypto Tracker 1.2.21

```bash
curl -fL -o org.mraurevox.CryptoTracker.flatpak \
  https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/crypto-tracker-v1.2.21/org.mraurevox.CryptoTracker.flatpak
...
- Texte complet : [`LEGAL-Crypto-Tracker.md`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/blob/main/LEGAL-Crypto-Tracker.md) et [`LEGAL.md`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/crypto-tracker-v1.2.21/LEGAL.md) (joint à la release). App : Paramètres → CGU / RGPD.
