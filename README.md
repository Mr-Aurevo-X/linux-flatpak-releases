...
| --- | --- | --- |
| **Crypto Tracker** | [`crypto-tracker-v1.2.3`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/crypto-tracker-v1.2.3) | `org.mraurevox.CryptoTracker.flatpak` |
...
curl -fL -o org.mraurevox.CryptoTracker.flatpak \
  https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/crypto-tracker-v1.2.3/org.mraurevox.CryptoTracker.flatpak
