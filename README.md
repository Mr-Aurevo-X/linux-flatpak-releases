...
| **Gest Linux Pro** | [`Gest_Linux_Pro-v1.4.7`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/Gest_Linux_Pro-v1.4.7) | `org.mraurevox.GestLinuxPro.flatpak` |
| **MrAurevoX Kit** | [`MrAurevoX-Kit-v0.2.3`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/MrAurevoX-Kit-v0.2.3) | `org.mraurevox.MrAurevoXKit.flatpak` |

## Crypto Tracker 1.2.9

```bash
curl -fL -o org.mraurevox.CryptoTracker.flatpak \
  https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/crypto-tracker-v1.2.9/org.mraurevox.CryptoTracker.flatpak
...
- Texte complet : [`LEGAL-Crypto-Tracker.md`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/blob/main/LEGAL-Crypto-Tracker.md) et [`LEGAL.md`](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/crypto-tracker-v1.2.9/LEGAL.md) (joint à la release). App : Paramètres → CGU / RGPD.
...
curl -fL -o org.mraurevox.GestLinuxPro.flatpak \
  https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/Gest_Linux_Pro-v1.4.7/org.mraurevox.GestLinuxPro.flatpak
...
curl -fL -o org.mraurevox.MrAurevoXKit.flatpak \
  https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/download/MrAurevoX-Kit-v0.2.3/org.mraurevox.MrAurevoXKit.flatpak
